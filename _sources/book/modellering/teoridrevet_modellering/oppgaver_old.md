...
::::{hints}
1. Sett først opp et uttrykk for omkretsen uttrykt med $x$ og $y$. 
2. Løs likningen for $y$ og la $x$ bestemme verdiene til $y$.
::::
...
Sett opp funksjonsuttrykket til Bjørn og lag en grafisk framstilling som viser sammenhengen mellom arealet og sidelengden $x$. 

Bruk den grafiske framstillingen til å bestemme hva sidelengdene må være for at arealet skal være størst mulig.
:::::::::::::
