...
def main(dirname):
    ...
    fignames = ["strategi_figur1.svg", "strategi_figur2.svg"]
    ...
    fig = Figure(
        ...
        SVG(dirname + "/strategi_figur1.svg").scale(1.25).move(0, 0),
        SVG(dirname + "/strategi_figur2.svg").scale(1.25).move(svg_width, 0),
    )
