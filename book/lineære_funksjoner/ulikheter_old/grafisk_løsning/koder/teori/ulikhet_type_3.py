...
ax[j].plot(
    x, f(x, a=c, b=d), color=plotmath.COLORS.get("red"), lw=2.5, label="$g(x) = cx + d$"
)
...
ax[j].hlines(0, x_sol, 8, color=plotmath.COLORS.get("skyblue"), alpha=0.9, lw=8)
...
ax[j].hlines(0, -8, x_sol, color=plotmath.COLORS.get("skyblue"), alpha=0.9, lw=8)
...
plt.savefig("../../figurer/teori/ulikhet_type_3.svg", transparent=True)
