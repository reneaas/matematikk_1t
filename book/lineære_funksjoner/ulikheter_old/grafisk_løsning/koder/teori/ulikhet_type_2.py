...
ax[j].hlines(k, -8, 8, color=plotmath.COLORS.get("red"), lw=2.5)
...
ax[j].hlines(0, (k - b) / a, 8, color=plotmath.COLORS.get("skyblue"), alpha=0.6, lw=8)
...
ax[j].hlines(0, -8, (k - b) / a, color=plotmath.COLORS.get("skyblue"), alpha=0.6, lw=8)
...
plt.savefig("../../figurer/teori/ulikhet_type_2.svg", transparent=True)
