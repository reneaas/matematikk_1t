...
fig, ax = plt.subplots()
ax.plot(
    x, f(x, a, b), color=plotmath.COLORS.get("blue"), lw=2.5, label="$f(x) = 2x + 1$"
)
ax.hlines(y, -10, 10, color=plotmath.COLORS.get("red"), lw=2.5, label="$y = 3$")
...
plt.savefig("../../figurer/eksempler/eksempel_2.svg", transparent=True)
