...
ax.plot(x, f(x, a=c, b=d), color="red", lw=2, alpha=0.7, label="$g(x) = cx + d$")
ax.plot(x_skjæring, y_skjæring, "ko", markersize=8, alpha=0.7)
ax.vlines(x_skjæring, 0, y_skjæring, color="black", linestyle="--", alpha=0.7)
...
plt.savefig("../../figurer/teori/skjæring_mellom_to_lineære_fn.svg")
