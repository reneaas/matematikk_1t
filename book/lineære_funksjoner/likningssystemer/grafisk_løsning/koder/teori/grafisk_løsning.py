...
fig, ax = plt.subplots()
ax.plot(x, f(x, a=a, b=b), color="teal", lw=2, alpha=0.7, label="$Ax + By = C$")
ax.plot(x, f(x, a=c, b=d), color="red", lw=2, alpha=0.7, label="$Dx + Ey = F$")
...
plt.savefig("../../figurer/teori/grafisk_løsning.svg")
