...
ax.text((x1 + x2) / 2, y1 - 0.3, r"$x - x_1$", fontsize=16, ha="center", va="center")
ax.text(x2 + 0.3, (y1 + y2) / 2, r"$y - y_1$", fontsize=16, ha="left", va="center")
...
plt.xticks([x1, x2], [r"$x_1$", r"$x$"], fontsize=16)

plt.yticks([y1, y2], [r"$y_1$", r"$y$"], fontsize=16)

plt.tight_layout()

# Lagrer figuren i vektorformat
plt.savefig("../../figurer/teori/ettpunktsformelen.svg")
