...
f = lambda x: -1 / 3 * x + 5 / 3
g = lambda x: 2 * x - 3

ax.plot(X, f(X), label=r"$x + 3y = 5$", lw=2, color="teal", alpha=0.7)
ax.plot(X, g(X), label=r"$2x - y = 3$", lw=2, color="purple", alpha=0.7)
