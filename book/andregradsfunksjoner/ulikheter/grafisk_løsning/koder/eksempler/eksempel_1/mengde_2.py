...
ax.hlines(y=0, xmin=-6, xmax=-3, lw=5, color="red", alpha=0.5)

ax.hlines(y=0, xmin=2, xmax=6, lw=5, color="red", alpha=0.5)
...
plt.savefig("../../../figurer/eksempler/eksempel_1/mengde_2.svg")
