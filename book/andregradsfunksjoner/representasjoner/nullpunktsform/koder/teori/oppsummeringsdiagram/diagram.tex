...
\node[box, fill=blue!5] (std) at (0,\H) {
  \textbf{Standardform}\\[2pt]
  $f(x)=ax^2+bx+c$\\[4pt]
  % selectively left-align these two lines:
  \makebox[\boxw][l]{\footnotesize $a > 0$: Konveks $\smile$}\\
  \makebox[\boxw][l]{\footnotesize $a < 0$: Konkav $\frown$}\\
  \makebox[\boxw][l]{\footnotesize Skjæring med $y$-aksen $(0, c)$}\\
  \makebox[\boxw][l]{\footnotesize Symmetrilinje: $x_0=-\dfrac{b}{2a}$}
};

\node[box, fill=red!5] (ext) at (-\L/2,0) {
  \textbf{Ekstremalpunktsform}\\[2pt]
  $f(x)=a(x-x_0)^2+y_0$\\[4pt]
  \makebox[\boxw][l]{\footnotesize $a > 0$: Konveks $\smile$}\\
  \makebox[\boxw][l]{\footnotesize $a < 0$: Konkav $\frown$} \\
  \makebox[\boxw][l]{\footnotesize Ekstremalpunkt: $(x_0, y_0)$}\\
  \makebox[\boxw][l]{\footnotesize Symmetrilinje: $x = x_0$}\\
};

\node[box, fill=green!5] (nul) at (\L/2,0) {
  \textbf{Nullpunktsform}\\[2pt]
  $f(x)=a(x-x_1)(x-x_2)$\\[4pt]
  \makebox[\boxw][l]{\footnotesize $a > 0$: Konveks $\smile$}\\
  \makebox[\boxw][l]{\footnotesize $a < 0$: Konkav $\frown$} \\
  \makebox[\boxw][l]{\footnotesize Nullpunkter: $(x_1, 0)$ og $(x_2, 0)$}\\
  \makebox[\boxw][l]{\footnotesize Symmetrilinje: $x_0 = \dfrac{x_1 + x_2}{2}$}\\
};
