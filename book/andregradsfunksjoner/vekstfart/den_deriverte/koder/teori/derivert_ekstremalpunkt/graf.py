...
def main(dirname, save):
    ...
    ax.hlines(y=ymin, xmin=-10, xmax=10, linestyle="-", color="red", alpha=0.7)

    # plt.annotate(
    #     text="Tangent med stigningstall $0$ \\iff $f'(x) = 0$",
    #     xy=(ymin, 3),
    #     xytext=(xmin + 0.25, ymin + 9),
    #     fontsize=fontsize,
    #     arrowprops=dict(
    ...
    plt.annotate(
        text=r"Tangent med stigningstall $0 \iff f'(x) = 0$",
        xy=(xmin, ymin),
        xytext=(xmin - 4, ymin - 4),
        fontsize=fontsize,
        arrowprops=dict(
            arrowstyle="->",
            lw=2,
