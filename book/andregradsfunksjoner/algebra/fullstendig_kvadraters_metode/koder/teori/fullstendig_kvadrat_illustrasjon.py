...
rect_b = patches.Rectangle(
    xy=(a, a), width=b, height=b, fill=True, color="green", alpha=0.2
)
...
rect_ab = patches.Rectangle(
    xy=(a, 0), width=b, height=a, fill=True, color="red", alpha=0.2
)
...
rect_ab2 = patches.Rectangle(
    xy=(0, a), width=a, height=b, fill=True, color="red", alpha=0.2
)
